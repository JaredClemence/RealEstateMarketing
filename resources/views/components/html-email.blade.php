...
@if( $testing == false )
<x-email.tracking-image source='images/HeadShotSmall.png' security-token='{{$mailId}}'></x-email.tracking-image>
@else
<x-email.tracking-image source='images/HeadShotSmall.png'></x-email.tracking-image>
@endif
<br/>
<x-email.medallion type='{{$medallionType}}'></x-email.medallion><br/>
